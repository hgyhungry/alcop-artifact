"""
Guyue: this test is deprecated; need to add test for topi.exp_cuda.dense_tensorcore
"""
...
_dense_implement = {"gpu": [(topi.cuda.dense_tensorcore_pipeline, topi.cuda.schedule_dense_tensorcore_pipeline)]}
...
def verify_dense(batch, in_dim, out_dim, dtype):
    ...
    @memoize("topi.tests.test_topi_dense_tensorcore_pipeline")
    def get_ref_data():
...
def test_dense_tensorcore_pipeline():
    """Test cases"""
    for dtype in ["float16"]:
        verify_dense(16, 32, 16, dtype,)
        verify_dense(256, 1024, 1024, dtype,)
        verify_dense(1024, 1024, 1024, dtype,)


if __name__ == "__main__":
    test_dense_tensorcore_pipeline()
